...
<main class="admin-main">
  <div class="toolbar admin-toolbar">
    <div><p class="eyebrow">ESTRADAPLAY · SERVIDOR 500 MB V2</p><h1>Central do Servidor</h1><p class="muted">Diagnóstico, espaço, catálogo e sincronização do Google Drive público.</p></div>
