...
<main class="admin-main">
  <div class="toolbar admin-toolbar">
    <div><p class="eyebrow">ESTRADAPLAY · SERVIDOR 500 MB V5</p><h1>Central do Servidor</h1><p class="muted">Diagnóstico, espaço, catálogo e sincronização do Google Drive público.</p></div>
    <div class="row"><a class="button secondary" href="admin_reports.php">Reportes da Estrada</a> <a class="button secondary" href="admin_collective.php">Inteligência Coletiva</a><a class="button secondary" href="admin_radio.php">Rádio da Rodovia</a><a class="button secondary" href="admin.php">Painel Admin</a><a class="button secondary" href="logout.php">Sair</a></div>
  </div>
