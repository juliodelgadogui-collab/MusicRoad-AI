...
final class NativeApiClient {
    ...
    Response get(String base,String path) throws Exception {return request(base,path,"GET",null,25000,16*1024*1024,null);}
