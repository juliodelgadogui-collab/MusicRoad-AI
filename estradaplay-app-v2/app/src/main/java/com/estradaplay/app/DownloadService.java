...
public final class DownloadService extends Service {
    static final String ACTION_START = "com.estradaplay.app.DOWNLOAD_START";
    static final String ACTION_STATE = "com.estradaplay.app.DOWNLOAD_STATE";
