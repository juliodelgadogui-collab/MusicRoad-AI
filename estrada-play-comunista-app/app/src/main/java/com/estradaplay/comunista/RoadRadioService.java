...
public final class RoadRadioService extends Service {
    static final String ACTION_JOIN="com.estradaplay.comunista.radio.JOIN",ACTION_LEAVE="com.estradaplay.comunista.radio.LEAVE",ACTION_PTT_ON="com.estradaplay.comunista.radio.PTT_ON",ACTION_PTT_OFF="com.estradaplay.comunista.radio.PTT_OFF",ACTION_MUTE="com.estradaplay.comunista.radio.MUTE",ACTION_ALERT="com.estradaplay.comunista.radio.ALERT",ACTION_QUERY="com.estradaplay.comunista.radio.QUERY",ACTION_SET_ROAD="com.estradaplay.comunista.radio.SET_ROAD",ACTION_STATE="com.estradaplay.comunista.radio.STATE";
    private static final String CHANNEL="epc_road_radio";
    ...
    private void initRtc(){
        ...
        localTrack=factory.createAudioTrack("epc-radio-audio",audioSource);
    ...
    private PeerState ensurePeer(String id){
        ...
        st.pc=pc;
        try{pc.addTrack(localTrack,Collections.singletonList("epc-radio"));}catch(Throwable ignored){}
