...
public final class CameraActivity extends ComponentActivity {
    ...
    private void toggleSmart(){boolean value=!smartSigns();prefs.edit().putBoolean(KEY_SMART,value).apply();if(smartButton!=null)smartButton.setText(value?"PLACA BETA · ON":"PLACA BETA · OFF",value?GOLD:MUTED);if(visionState!=null)visionState.setText(value?"VISÃO BETA · REABRINDO CÂMERA":"VISÃO BETA · DESLIGADA");if(cameraProvider!=null)try{cameraProvider.unbindAll();}catch(Throwable ignored){}handler.postDelayed(this::startCamera,250);}
