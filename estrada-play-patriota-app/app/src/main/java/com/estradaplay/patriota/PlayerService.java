...
public final class PlayerService extends Service {
    static final String ACTION_PLAY_TRACK = "com.estradaplay.patriota.PLAY_TRACK";
    static final String ACTION_TOGGLE = "com.estradaplay.patriota.PLAYER_TOGGLE";
    static final String ACTION_NEXT = "com.estradaplay.patriota.PLAYER_NEXT";
    static final String ACTION_PREVIOUS = "com.estradaplay.patriota.PLAYER_PREVIOUS";
    static final String ACTION_DUCK = "com.estradaplay.patriota.PLAYER_DUCK";
    static final String ACTION_UNDUCK = "com.estradaplay.patriota.PLAYER_UNDUCK";
    static final String ACTION_STATE = "com.estradaplay.patriota.PLAYER_STATE";
    static final String ACTION_QUERY_STATE = "com.estradaplay.patriota.PLAYER_QUERY_STATE";
    ...
    private Notification notification(Track t, boolean playing) {
        ...
        b.setSmallIcon(android.R.drawable.ic_media_play)
                .setContentTitle(t == null ? "Estrada Play Patriota" : t.title)
