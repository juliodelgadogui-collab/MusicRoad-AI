...
public final class DownloadService extends Service {
    static final String ACTION_START = "com.estradaplay.patriota.DOWNLOAD_START";
    static final String ACTION_STATE = "com.estradaplay.patriota.DOWNLOAD_STATE";
    ...
    private Notification notification(String text, int done, int total, boolean indeterminate) {
        ...
        b.setSmallIcon(android.R.drawable.stat_sys_download)
                .setContentTitle("Estrada Play Patriota")
                .setContentText(text)
                .setOngoing(running)
