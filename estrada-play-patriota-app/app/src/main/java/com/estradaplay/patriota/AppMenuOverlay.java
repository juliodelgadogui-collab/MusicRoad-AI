...
final class AppMenuOverlay {
    ...
    static void show(Context context, FrameLayout host, String currentScreen, Listener listener) {
        ...
        View old = host.findViewWithTag("epp-central-overlay");
        if (old != null) host.removeView(old);

        FrameLayout overlay = new FrameLayout(context);
        overlay.setTag("epp-central-overlay");
        ...
        TextView code = text(context, "EPP  /  COMANDO DE BORDO", 9, Color.rgb(255, 222, 180), true);
