...
public final class ThoughtsActivity extends ComponentActivity {
    ...
    private void build() {
        ...
        TextView over=text("EPP / COPILOTO",9,GOLD,true); over.setLetterSpacing(.12f); page.addView(over);
        page.addView(text("PENSAMENTOS DA ESTRADA",26,TEXT,true));
        TextView desc=text("Frases curtas em forma de paráfrase, inspiradas em autores socialistas e patriotas. Nunca são tratadas como citação literal e nunca têm prioridade sobre um alerta de segurança.",13,MUTED,false);
