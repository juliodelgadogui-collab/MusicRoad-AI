...
s=s.replace('private PeerConnectionFactory factory;private JavaAudioDeviceModule adm;private AudioSource audioSource;', 'private PeerConnectionFactory factory;private AudioDeviceModule adm;private AudioSource audioSource;')
